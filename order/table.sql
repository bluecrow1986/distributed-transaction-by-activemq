...
CREATE TABLE `tb_order`  (
  ...
  `pay_id` bigint(20) NULL DEFAULT NULL COMMENT '支付订单号',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单事件表' ROW_FORMAT = Dynamic;
